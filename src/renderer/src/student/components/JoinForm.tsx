...
export function JoinForm({
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-pulse-600 px-6 text-center">
      <div className="mb-8 flex h-16 w-16 items-center justify-center rounded-2xl bg-white text-2xl font-bold text-pulse-600">
        P
      </div>
      <h1 className="mb-1 text-2xl font-bold text-white">Join the class</h1>
      <p className="mb-8 text-sm text-pulse-100">Enter the code your instructor is showing.</p>
      <form
      ...
      >
        ...
        />
        {error && <p className="mb-4 text-sm font-medium text-white">{error}</p>}
        <button
          type="submit"
